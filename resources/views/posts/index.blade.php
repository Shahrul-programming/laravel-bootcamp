...
@section('content')
    <div class="max-w-6xl mx-auto px-6 py-16">
            ...
            <h1 class="text-3xl font-light tracking-wide text-gray-800 mb-4">Blog Post</h1>
            ...
            <article class="bg-gray-50 rounded-lg p-6 hover:shadow-sm transition-shadow duration-200">
                ...
                <time datetime="2024-12-15" class="text-gray-400">{{\Carbon\Carbon::parse($post['created_at'])->format('d M Y')}}</time>
